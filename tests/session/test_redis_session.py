...
class TestRedisSessionManager:
    ...
    def test_validate_session(self, session_manager):
        ...
        # Validate session
        result = manager.validate_session("test-session-id")
    ...
    def test_validate_session_invalid(self, session_manager):
        ...
        # Verify Redis was called correctly
        mock_redis.get.assert_called_with("session:invalid-session-id")

    def test_set_session_cookie(self):
        """Test setting a session cookie."""
        # Skip this test as it requires FastAPI Response
