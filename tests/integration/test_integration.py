...
class TestAPIIntegration:
    ...
    def test_feedback_endpoint(self, client, monkeypatch):
        ...
        # Mock the db_manager.log_analytics_event method to avoid DB dependency
        with patch('src.api.routes.misc.logger') as mock_logger:
            feedback_data = {
...
@pytest.mark.asyncio
async def test_minimal_app_ping(minimal_app):
