...
the SQLite database containing tourism information.
"""
import os
import json
import sqlite3
...
class DatabaseManager:
    """
    Database manager for SQLite access.
    
    This class provides methods for connecting to and querying the
    SQLite database containing tourism information.
    """
    ...
    def search_hotels(
        ...
        """
        # Build the query
        query = "SELECT * FROM accommodations WHERE type = 'hotel'"
        params = []
